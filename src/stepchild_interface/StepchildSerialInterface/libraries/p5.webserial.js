//This is an ever-so-slightly modified version of this library:
...
//refactored to not use anything from p5. We did it this way because the original prototype for the stepchild interface was written using p5.js.

'use strict';

// Can be called with ArrayBuffers or views on them
export function memcpy(dst, dstOffset, src, srcOffset, len) {
...
export function usedSerialPorts(){
  return ports;
}
